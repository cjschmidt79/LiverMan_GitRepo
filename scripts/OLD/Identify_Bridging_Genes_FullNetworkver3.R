...
qmd_lines <- c(
  ...
  "## Interpretation",
  "",
  "Genes with **high participation** connect across multiple communities (module connectors), whereas **high betweenness** indicates bottleneck-like traversal roles. Genes high on both dimensions are candidate system-level integrators.",
  "",
